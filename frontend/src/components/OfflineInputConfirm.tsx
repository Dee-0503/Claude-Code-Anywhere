...
export function renderOfflineInputConfirm(pendingInputs: readonly Pick<PendingInput, "inputId" | "payload">[]): string {
...
export function OfflineInputConfirm({ pendingInputs, onConfirm }: OfflineInputConfirmProps): ReactElement | null {
  if (pendingInputs.length === 0) {
    return null;
  }
